...
module.exports = {
    fileRead() 
    {
        ...
        var f = fileStream.readFileSync('/home/admin1/Bridgelabz_Programs/DataStructure/UnOrderList.txt', 'utf8');
    ...
    {
        var fileStream = require('fs');
        var f = fileStream.readFileSync('/home/admin1/Bridgelabz_Programs/DataStructure/OrderList.txt', 'utf8');
        var arr = f.trim().split(' ');
        return arr;
    },
    /**************************************************************************************
