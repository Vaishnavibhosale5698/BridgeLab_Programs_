/*******************************************************************************************************************/
//  * @purpose : To deploy all the business logic related to clinic Management
//  * @file    : ClinicManagementUtil.js
...
class Doctor extends Clinic {
         ...
         while (numbers != 4) {
            ...
            switch (parseInt(numbers)) {
               ...
               case 4:
                      ...
                      break;   
               default:
                  console.log("Please Enetr correct Choice!!");
                  break;
   ...
   appointment(data) {
      ...
      try {
         ...
         file.writeFileSync('ClinicManagement.json', JSON.stringify(data));
